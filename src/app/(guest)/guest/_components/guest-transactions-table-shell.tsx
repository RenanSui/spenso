...
import { GuestDataTable } from '../groups/[groupId]/_components/guest-data-table'
import { GuestChangeTransactionGroup } from './guest-change-transaction-group'
import { GuestDeleteTransaction } from './guest-delete-transaction'
import { GuestUpdateTransaction } from './guest-update-transaction'

interface GuestTransactionsTableShellProps {
  data: Transaction[]
  rates: (CurrencyRates | null)[]
  groupId?: string
}

export function GuestTransactionsTableShell({ data: transactions, rates, groupId }: GuestTransactionsTableShellProps) {
