...
interface GuestGroupTabsProps {
  groupId: string
}
export function GuestGroupTabs({ groupId }: GuestGroupTabsProps) {
  ...
  const tabs = [
    {
      title: 'Group',
      href: `/guest/groups/${groupId}`,
      isActive: segment === null,
    },
    {
      title: 'Transactions',
      href: `/guest/groups/${groupId}/transactions`,
      isActive: segment === 'transactions',
    },
    {
      title: 'Analytics',
      href: `/guest/groups/${groupId}/analytics`,
